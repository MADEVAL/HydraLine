/// Custom Element `<hydraline-island>` (pretty, branded).
///
/// Reuses the server-rendered Declarative Shadow DOM (no FOUC) and pins
/// island dimensions with a ResizeObserver (Flutter #185034 workaround).
///
/// Kept byte-identical to `web/hydraline-island.js` (verified by test).
library;

const jsCustomElement =
    r'''/*! ==========================================================================
